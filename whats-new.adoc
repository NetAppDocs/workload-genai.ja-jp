...
summary: Workload Factory の AI ワークロード機能の新機能について説明します。 
---
...
link:https://docs.netapp.com/us-en/workload-genai/general/monitor-operations.html["NetApp Workload FactoryのTrackerでワークロード操作を監視する"]
...
link:https://docs.netapp.com/us-en/workload-genai/general/ai-workloads-overview.html#benefits-of-using-genai-to-create-generative-ai-applications["GenAI向けNetAppワークロードファクトリーの詳細"]
